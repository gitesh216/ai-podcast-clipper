...
export default function BillingPage() {
  return (
    <div className="mx-auto flex min-h-[80vh] flex-col justify-center px-4 py-12">
        ...
        <Card className="mt-12">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardTitle className="text-2xl font-bold sm:text-3xl">
              Billing is in development
            </CardTitle>
            <p className="text-muted-foreground text-sm sm:text-base">
              We’re currently building the billing & credits purchase
          ...
          <CardContent className="space-y-4">
            <div className="bg-muted/50 rounded-lg p-4 text-sm">
              <p className="font-medium">What you can do for now</p>
              <ul className="text-muted-foreground mt-2 list-disc space-y-1 pl-5">
                <li>Continue using your current credits</li>
                <li>Check back later for credit packs</li>
                <li>
                  If you need more credits urgently, contact support/admin
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
              ...
              <Button asChild variant="outline" className="w-full sm:flex-1">
                <Link href="/support" className="w-full text-center">
                  Contact Support
                </Link>
              </Button>
            </div>
